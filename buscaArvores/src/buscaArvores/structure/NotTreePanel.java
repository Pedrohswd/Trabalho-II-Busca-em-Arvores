...
public class NotTreePanel extends JPanel{
    private NotTree.Node root;
    double i=1;
    
    public NotTreePanel(NotTree.Node root){
        this.root = root;
    }
    ...
    private void drawTree(Graphics g, int x, int y, int width, int fontSize, NotTree.Node node) {
        if (node == null) {
            return;
        }
